            ...
            <div className="ps-shoe mb-30">
              <div className="ps-shoe__thumbnail">
                <div className="ps-badge" style={{ width: "40px" }}>
                  <span style={{ fontSize: "12px" }}>Artisanat</span>
                </div>
              ...
              <div className="ps-shoe__content">
                ...
                {/* <div className="ps-shoe__variants">
                  <div className="ps-shoe__variant normal">
                    <img src="images/arti-product/2.jpg" alt="" />
                    <img src="images/arti-product/3.jpg" alt="" />
                    <img src="images/arti-product/4.jpg" alt="" />
                    <img src="images/arti-product/5.jpg" alt="" />
                  </div>
